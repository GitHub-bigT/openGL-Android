...
void Handle::drawTriangles(int type, float alpha, glm::vec3 cameraPos, glm::vec3 cameraFront, glm::vec3 cameraUp){
	//std::cout << "draw triangle" << std::endl;
	btVaoVbo->drawArrays(type , programId, alpha , cameraPos,cameraFront,cameraUp);
}
Handle::Handle()
{
